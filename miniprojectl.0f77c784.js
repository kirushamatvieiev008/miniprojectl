...
const getData = ()=>fetch(`https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=${search}&page=${page}&per_page=5&key=${API_KEY}`).then((res)=>res.json());
// let searchInside = '';
let globalSearch = "";
searchInp.addEventListener("input", (0, _lodashDebounceDefault.default)((event)=>{
...
},{"../node_modules/lodash.debounce":"irvaP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire5ba9", {})

//# sourceMappingURL=miniprojectl.0f77c784.js.map
